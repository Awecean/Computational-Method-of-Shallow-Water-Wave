% Main.m 
% This is the revised main program of Assignment 5
% Which use to check the hllc-solver is functional
...
fprintf('vec{u^-}');fprintf('%.2f,',u1L);fprintf('X'); fprintf('\n');
...
fprintf('vec{u^-}');fprintf('%.2f,',u2L);fprintf('X'); fprintf('\n');
%%
