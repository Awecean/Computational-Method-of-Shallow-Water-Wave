function [etanext, Unext] = ssprk_LSWE(eta, u, h, dx, dt, n)
%SSP-RK for linear shallow water equation
%
g = 9.81;
...
% SSP-RK processing
    ...
    etat1 = wv.bc(etat1(3:end-2), 'mirror', 'eta');
    Ut1 = wv.bc(Ut1(3:end-2),'mirror','u');
    ...
    etat2 = wv.bc(etat2(3:end-2), 'mirror', 'eta');
    Ut2 = wv.bc(Ut2(3:end-2), 'mirror','u');
    ...
    etanext = wv.bc(etanext(3:end-2), 'mirror', 'eta');
    Unext = wv.bc(Unext(3:end-2),'mirror', 'u');
end
